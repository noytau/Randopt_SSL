...
echo "qwen2.5.1.5b x Countdown | N=500 K=50 | real HF data"
...
python3 -m scripts.run \
    ...
    --output_dir $WORKDIR/results/qwen2_5_1_5b_countdown_n500 \
    --wandb_project randopt-benchmark
echo "Done: $WORKDIR/results/qwen2_5_1_5b_countdown_n500"
