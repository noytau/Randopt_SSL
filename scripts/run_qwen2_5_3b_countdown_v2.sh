...
echo "qwen2.5.3b-v2 x Countdown (real HF data) | N=3000 K=50"
...
python3 -m scripts.run \
    ...
    --output_dir $WORKDIR/results/qwen2_5_3b_countdown_v2 \
    --wandb_project randopt-benchmark
echo "Done: $WORKDIR/results/qwen2_5_3b_countdown_v2"
