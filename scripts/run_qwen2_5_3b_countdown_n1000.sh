...
echo "qwen2.5.3b x Countdown | N=1000 K=50 | real HF data"
...
python3 -m scripts.run \
    ...
    --output_dir $WORKDIR/results/qwen2_5_3b_countdown_n1000 \
    --wandb_project randopt-benchmark
echo "Done: $WORKDIR/results/qwen2_5_3b_countdown_n1000"
