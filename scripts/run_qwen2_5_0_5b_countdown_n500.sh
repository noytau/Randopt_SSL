...
echo "qwen2.5.0.5b x Countdown | N=500 K=50 | real HF data"
...
python3 -m scripts.run \
    ...
    --n_candidates 500 --top_k 50 \
    --output_dir $WORKDIR/results/qwen2_5_0_5b_countdown_n500 \
    --wandb_project randopt-benchmark
echo "Done: $WORKDIR/results/qwen2_5_0_5b_countdown_n500"
